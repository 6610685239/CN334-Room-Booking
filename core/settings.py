...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "tu_booking_db"),
        "USER": os.environ.get("DB_USER", "tu_admin"),
...
DEFAULT_FROM_EMAIL = f"Engineering Room Booking <{EMAIL_HOST_USER}>"

FIXTURE_DIRS = [os.path.join(BASE_DIR, "bookings")]
